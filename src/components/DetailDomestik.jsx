          ...
          <div className="mt-16 md:mt-24">
            <div className={`relative rounded-3xl overflow-hidden shadow-xl min-h-[200px] md:min-h-[250px] flex items-center ${config.domCtaBgColor || 'bg-[#1e3a8a]'}`}>
              <div className="absolute inset-0 w-full h-full">
                <img src={config.domCtaBg || "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=2000"} className="w-full h-full object-cover object-center" />
              </div>
              <div className={`absolute inset-0 bg-gradient-to-r ${getCtaGradient(config.domCtaBgColor || 'bg-[#1e3a8a]')}`}></div>
              ...
              <div className="relative z-10 w-full md:w-2/3 p-8 md:p-12 text-left">
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-3 md:mb-4 leading-snug">
                  {config.domCtaTitle || "Ingin Menyesuaikan Isi Paket Ini?"}
                </h2>
