...
function SemuaDestinasiInt() {
  ...
  return (
    <div className="pt-20 pb-20 bg-slate-50 min-h-screen font-sans">
      ...
      <div className="relative bg-[#0f172a] pt-16 pb-36 md:pt-24 md:pb-40 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-4 drop-shadow-md">
            Katalog <span className="text-[#f59e0b]">Kawasan & Negara</span>
          </h1>
          <p className="text-blue-100 text-sm md:text-lg max-w-2xl mx-auto leading-relaxed">
            Jelajahi berbagai pilihan kawasan dan negara wisata terbaik di seluruh dunia bersama kami.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 -mt-10 md:-mt-12 mb-12">
        <div className="bg-white rounded-2xl shadow-xl p-3 md:p-4 border border-gray-100 flex items-center">
          <div className="flex-1 relative">
            ...
            <input 
              type="text" 
              placeholder="Cari kawasan atau negara..." 
              value={searchQuery} 
      ...
      {/* 3. GRID DESTINASI (Disamakan dengan Kartu di Internasional.jsx) */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {!loading && daerahList.length > 0 && (
          <div className="mb-6 text-gray-500 text-sm font-medium text-center md:text-left">
            Menampilkan <span className="font-bold text-[#1e3a8a]">{filteredDaerah.length}</span> kawasan populer.
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-3xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500">Katalog kawasan wisata internasional sedang dalam tahap pembaruan.</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {filteredDaerah.map((daerah) => (
              <Link 
                to={`/internasional/destinasi/${daerah.title}`} 
                key={daerah.id} 
              ...
              >
                <img 
                  src={daerah.image || "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=800"} 
                  alt={daerah.title} 
